...
describe("chooseDestinationArea", () => {
  const areas: Area[] = [
    { id: "a1", name: "Hyde Park", city: "london", type: "park", position: { x: 0, y: 0 }, capacity: 20, currentOccupants: [], ambiance: "peaceful" },
    { id: "a2", name: "British Library", city: "london", type: "library", position: { x: 1, y: 0 }, capacity: 15, currentOccupants: [], ambiance: "quiet" },
    { id: "a3", name: "Shoreditch Studio", city: "london", type: "studio", position: { x: 2, y: 0 }, capacity: 8, currentOccupants: [], ambiance: "creative" },
    { id: "a4", name: "Borough Market", city: "london", type: "market", position: { x: 3, y: 0 }, capacity: 30, currentOccupants: [], ambiance: "buzzing" },
  ];
